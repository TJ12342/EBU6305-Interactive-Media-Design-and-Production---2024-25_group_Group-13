        ...
        content: {
            ...
            applications: {
                ...
                interactive: {
                    ...
                    description: "Explore how to apply quadratic equations to solve real-world problems in this interactive sandbox:",
                    tab1: "Projectile Motion",
                    tab2: "Revenue Optimization",
                    tab3: "Area Maximization",
                    launch: "Launch",
                    reset: "Reset",
                    projectile: {
                        title: "Basketball Throw Simulator",
                        description: "Adjust parameters to see how they affect the trajectory of a basketball throw.",
                        initialHeight: "Initial Height (m): ",
                        heightHint: "Height of the player's hands when throwing",
                        initialVelocity: "Initial Velocity (m/s): ",
                        velocityHint: "How fast the ball is thrown",
                        angle: "Angle (degrees): ",
                        angleHint: "Angle of the throw relative to horizontal",
                        equationTitle: "Resulting Equations:",
                        horizontal: "Horizontal position:",
                        vertical: "Vertical position:",
                        analysisTitle: "Trajectory Analysis:",
                        maxHeight: "Maximum Height:",
                        timeInAir: "Time in Air:",
                        distance: "Horizontal Distance:"
                    },
                    revenue: {
                        title: "Ticket Pricing Simulator",
                        description: "Find the optimal ticket price to maximize revenue for your event.",
                        basePrice: "Base Price ($): ",
                        basePriceHint: "Starting ticket price",
                        baseDemand: "Base Demand (tickets): ",
                        baseDemandHint: "Number of tickets sold at base price",
                        elasticity: "Price Elasticity: ",
                        elasticityHint: "Tickets lost per $1 increase",
                        equationTitle: "Resulting Equations:",
                        demandEquation: "Demand Equation:",
                        revenueEquation: "Revenue Equation:",
                    ...
                    area: {
                        title: "Fencing Problem Simulator",
                        description: "Find the dimensions that maximize the area of a rectangular field given a fixed amount of fencing.",
                        perimeter: "Total Fencing (m): ",
                        perimeterHint: "Total length of available fencing",
                        width: "Width (m): ",
                        widthHint: "Adjust to see how width affects area",
                        equationTitle: "Resulting Equations:",
                        perimeterEquation: "Perimeter Equation:",
                        lengthEquation: "Length Equation:",
                        areaEquation: "Area Equation:",
                        analysisTitle: "Area Analysis:",
                        currentWidth: "Current Width:",
                        currentLength: "Current Length:",
                        currentArea: "Current Area:",
                        optimalDimensions: "Optimal Dimensions:",
